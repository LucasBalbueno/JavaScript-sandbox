// 01) Fazer um programa que imprima a média aritmética dos números 8,9 e 7. A média dos números 4, 5 e 6. A soma das duas médias.
...
// 03) Solicitar salário, prestação. Se prestação for maior que 20% do
// salário, imprimir : Empréstimo não pode ser concedido. Senão
